...
INSERT INTO pool.config (module, item, item_value, item_type, Item_desc) VALUES ('payout', 'pplnsFee', '0.6', 'float', 'Fee charged for the usage of the PPLNS pool');
...
INSERT INTO pool.config (module, item, item_value, item_type, Item_desc) VALUES ('payout', 'walletMin', '0.3', 'float', 'Minimum XMR balance for payout to personal wallet');
...
INSERT INTO pool.config (module, item, item_value, item_type, Item_desc) VALUES ('payout', 'maxTxnValue', '5000', 'int', 'Maximum amount of XMR to send in a single transaction');
